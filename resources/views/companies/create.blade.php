    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-sm-6">
                <h4 class="mb-0 text-dark font-weight-bold">Add Company</h4>
            </div>
        </div>
    </div>
</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="company_email" id="company_email" value="{{ old('company_email') }}" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="company_name" class="col-form-label">Company Website</label>
                                                <input type="text" name="company_website" id="company_website" value="{{ old('company_website') }}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
